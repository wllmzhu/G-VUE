...
class RavensMultiTaskDataset(RavensDataset):
    ...
    SEEN_TASKS = [
        'assembling-kits-seq-seen-colors', 'packing-seen-google-objects-group',
        'put-block-in-bowl-seen-colors', 'stack-block-pyramid-seq-seen-colors',
        'packing-seen-google-objects-seq', 'packing-boxes-pairs-seen-colors',
        'separating-piles-seen-colors', 'towers-of-hanoi-seq-seen-colors'
    ]
    ...
    MULTI_TASKS = {
        'seen_unseen': {
            'train': SEEN_TASKS, 'val': UNSEEN_TASKS, 'test': UNSEEN_TASKS
        }
    }

    def __init__(self, path, cfg, group='multi',
