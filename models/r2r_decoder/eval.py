...
from models.r2r_decoder.utils import load_datasets, load_nav_graphs, ndtw_graphload, DTW
from models.r2r_decoder.agent import BaseAgent
...
class Evaluation(object):
    ...
    def __init__(self, cfg, splits, scans, tok):
        ...
        self.scans = []
        for split in splits:
            for item in load_datasets(cfg, [split]):
        ...
        self.graphs = load_nav_graphs(cfg, self.scans)
        self.distances = {}
