...
class VLNBERT(nn.Module):
    ...
    def forward(self, cfg, mode, sentence, token_type_ids=None,
        ...
        if mode == 'language':
            ...
            cand_feats[..., :-cfg.model.decoder.angle_feat_size] = self.drop_env(cand_feats[..., :-cfg.model.decoder.angle_feat_size])
