# --------------------------------------------------------
# Swin Transformer
# adapted from https://github.com/microsoft/GLIP/blob/e496d64141086fbd5f064ee6f4a9b7427f0be101/maskrcnn_benchmark/modeling/backbone/swint.py
# --------------------------------------------------------
...
def build_swint_backbone(cfg):
    ...
    return SwinTransformer(
        ...
        ape=cfg.APE,
        patch_norm=True,
        frozen_stages=cfg.FREEZE_CONV_BODY_AT,
        backbone_arch=cfg.CONV_BODY,
